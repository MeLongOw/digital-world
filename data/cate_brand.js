const data = [
    ...
    {
        cate: 'Speaker',
        brand: ['Asus', 'Dell', 'Acer', 'Lenovo', 'HP', 'Macbook', 'JBL', "USB", 'Motorola', 'Logitech', 'Apple', 'Sennheiser', 'Samsung'],
        image: 'https://cdn-amz.woka.io/images/I/51KZcUQIyiS.jpg'
    },
    {
        cate: 'Camera',
        brand: ['Asus', 'Dell', 'Acer', 'Lenovo', 'HP', 'Macbook', 'Motorola', 'Logitech', 'JBL', 'Apple', 'USB', 'Sennheiser', 'Samsung'],
        image: 'https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn//News/0//camera-giam-sat-3-800x533.jpg'
    },
    {
        cate: 'Accessories',
        brand: ['Smartswatches', 'Headphone', 'Bluetooth', 'Keyboard', 'Mouse', 'Cases', 'Motorola', 'Logitech', 'JBL', 'USB', "Samsung", 'Sennheiser', 'Apple'],
    ...
    {
        cate: 'Television',
        brand: ['Apple', 'Samsung', 'LG', 'Asus', 'Nokia', 'BlackBerry', 'Logitech', 'Motorola', 'USB', 'Sennheiser'],
        image: 'https://cdn.shopify.com/s/files/1/1903/4853/files/television_300x.jpg?v=1613166810'
    },
    {
        cate: 'Printer',
        brand: ['Samsung', 'Acer', 'Asus', 'Lenovo', 'Haier', 'USB', 'Motorola', 'Logitech', 'JBL',"Apple", 'Sennheiser'],
